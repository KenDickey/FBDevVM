/* sqUnixEvdevDebug.h -- libevdev mouse & keyboard debug
 *
 * From "evtest": written by Vojtech Pavlik <vojtech@suse.cz>.
 * http://lists.freedesktop.org/mailman/listinfo/input-tools
 * Modified for OpenSmalltalk VM by: Ken.Dickey@whidbey.com
